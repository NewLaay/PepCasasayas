...
<table>
    ...
    $elephantsOrdened = getSortedElephantsByNumber($elephants);
    ...
    for($i=0;$i<count($elephants);$i++){
        ...
        echo "<td>".$elephantsOrdened[$i]['number']."</td>";
        echo "<td>".$elephantsOrdened[$i]['name']."</td>";
        echo "<td>".$elephantsOrdened[$i]['species']."</td>";
        echo "</tr>";
    }
