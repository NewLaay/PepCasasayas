...
if (isset($_POST["mail"]) && isset($_POST["password"])) {
    $file = file_get_contents("http://localhost/dawsonferrer/allabres/APIs/mallorcasa_back/Controllers/loginController.php?mail=".$_POST["mail"]."&password=".$_POST["password"]);
